"""Queuing Theory Deep Dive: rendered from docs/theory.qmd"""
import os, re, streamlit as st
st.set_page_config(page_title="Queuing Theory", page_icon="📐", layout="wide")
...
qmd = os.path.join(os.path.dirname(os.path.dirname(__file__)), "docs", "theory.qmd")
