"""Simulator Guide: rendered from docs/simulator.qmd"""
import os, re, streamlit as st
st.set_page_config(page_title="Simulator Guide", page_icon="🛠️", layout="wide")
...
qmd = os.path.join(os.path.dirname(os.path.dirname(__file__)), "docs", "simulator.qmd")
